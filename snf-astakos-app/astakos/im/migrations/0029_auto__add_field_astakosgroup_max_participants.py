...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('im_astakosgroup', 'max_participants', self.gf('django.db.models.fields.PositiveIntegerField')(null=True), keep_default=False)
    ...
    models = {
        ...
        'im.approvalterms': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 3, 18, 19, 31, 149726)', 'db_index': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'im.astakosgroup': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 3, 18, 19, 31, 143514)'}),
            ...
            'max_participants': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True'}),
        ...
        'im.emailchange': {
            ...
            'requested_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 3, 18, 19, 31, 151260)'}),
        ...
        'im.membership': {
            ...
            'date_requested': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 11, 3, 18, 19, 31, 147446)', 'blank': 'True'}),
