...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column('im_astakosuserquota', 'import_limit', self.gf('synnefo.lib.db.intdecimalfield.IntDecimalField')(default=100000000000000000000000000000000L, max_digits=38, decimal_places=0), keep_default=False)

        # Adding field 'AstakosUserQuota.export_limit'
        db.add_column('im_astakosuserquota', 'export_limit', self.gf('synnefo.lib.db.intdecimalfield.IntDecimalField')(default=100000000000000000000000000000000L, max_digits=38, decimal_places=0), keep_default=False)

        # Adding field 'AstakosUserQuota.quantity'
        db.add_column('im_astakosuserquota', 'quantity', self.gf('synnefo.lib.db.intdecimalfield.IntDecimalField')(default=0, max_digits=38, decimal_places=0), keep_default=False)
    ...
    models = {
        ...
        'im.astakosuserquota': {
            ...
            'capacity': ('synnefo.lib.db.intdecimalfield.IntDecimalField', [], {'default': '0', 'max_digits': '38', 'decimal_places': '0'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
