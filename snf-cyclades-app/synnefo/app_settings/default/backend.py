...
BACKEND_ALLOCATOR_MODULE = 'synnefo.logic.allocators.filter_allocator.FilterAllocator'
BACKEND_FILTER_ALLOCATOR_FILTERS = [
    'synnefo.logic.allocators.filter_project_backends.ProjectBackendsFilter',
    'synnefo.logic.allocators.filter_default.DefaultFilter'
]
...
# Root path on which the rescue images should be placed.
RESCUE_IMAGE_PATH = '/usr/share/synnefo/rescue-images'
