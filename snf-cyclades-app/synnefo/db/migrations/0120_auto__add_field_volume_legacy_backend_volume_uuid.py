...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Volume.legacy_backend_volume_uuid'
        db.add_column('db_volume', 'legacy_backend_volume_uuid',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Volume.legacy_backend_volume_uuid'
        db.delete_column('db_volume', 'legacy_backend_volume_uuid')
