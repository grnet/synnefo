...
toggleCtrl: function(){
    if (document.getElementById('noVNC_ctrl_box').checked) {
        document.getElementById('noVNC_ctrl_box').checked = false;
        $D('toggleCtrlButton').className = "noVNC_status_button";
    } else{
        document.getElementById('noVNC_ctrl_box').checked = true;
...
toggleAlt: function(){
    if (document.getElementById('noVNC_alt_box').checked) {
        document.getElementById('noVNC_alt_box').checked = false;
        $D('toggleAltButton').className = "noVNC_status_button";
    } else{
        document.getElementById('noVNC_alt_box').checked = true;
