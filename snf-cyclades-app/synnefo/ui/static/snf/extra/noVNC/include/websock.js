...
if (window.WebSocket && !window.WEB_SOCKET_FORCE_FLASH) {
    ...
    (function () {
	var base_path = MEDIA_URL + "extra/noVNC/include/";
        window.WEB_SOCKET_SWF_LOCATION = base_path + 
	...
	var INCLUDE_URI = '';
        Util.load_scripts([base_path + "web-socket-js/swfobject.js",
                           base_path + "web-socket-js/web_socket.js"]);
    }());
}
